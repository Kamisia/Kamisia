...
- observability workflows and monitoring concepts
- frontend performance and reliability
- API-driven UI architecture
- structured state management and async data handling
...
Self-initiated project exploring Dynatrace ecosystem concepts, translating runtime monitoring data into actionable service-ownership tooling for developers.

### Household Budget Planner
Data-driven React application built to practice clean architecture, realistic data flows, and testing-focused development.

---

## Contact

LinkedIn: https://linkedin.com/in/kamila-samczuk  
Email: kamila@samcz.uk
